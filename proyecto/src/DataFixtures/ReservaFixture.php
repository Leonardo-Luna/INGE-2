...
class ReservaFixture extends Fixture implements FixtureGroupInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $usuarioPipo = $manager->getRepository(User::class)->findOneBy(['email' => 'santi2frames@gmail.com']);
        ...
        $reserva->setUsuario($usuarioPipo);
        ...
        $reserva2->setUsuario($usuarioPipo);
        $reserva2->setCostoTotal(60000);
        $reserva2->setMontoReembolso(300);
        $reserva2->setReembolsoPenalizado(100);
        ...
        $reserva3->setReembolsoPenalizado(100);
        ...
        $reservaCancelada->setFechaInicio(new DateTime('2025-07-16'));
        $reservaCancelada->setFechaFin(new DateTime('2025-07-30'));
        ...
        $reservaEnCurso->setUsuario($usuarioPipo);
        ...
        $reservaEnCurso->setFechaFin(new DateTime('2025-07-17'));
