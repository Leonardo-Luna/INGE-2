...
echo ">>> Cargando fixture de clientes <<<";
bin/console doctrine:fixtures:load --group="fixtureClientes" --append
...
echo ">>> Cargando fixture de reservas <<<";
bin/console doctrine:fixtures:load --group="fixtureReservas" --append
